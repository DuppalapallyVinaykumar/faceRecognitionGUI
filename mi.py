...
# whether the text below is a number or not.
...
def TakeImages():
    # Both ID and Name are used for recognizing the Image
    Id = (txt.get())
    name = (txt2.get())
...
# Training the images saved in the training image folder
def TrainImages():
    ...
    # Saving the trained faces and their respective IDs
...
# For testing phase
def TrackImages():
    recognizer = cv2.face_LBPHFaceRecognizer.create()  # Change this line
